...
if (!testBinary) throw new Error("TOKENFOLD_TEST_BINARY must point to a tokenfold 0.3.4 binary");
...
test("resolves an explicit binary and reports its version", async () => {
  ...
  assert.match(Buffer.from(result.stdout).toString(), /^tokenfold 0\.3\.4/);
});
